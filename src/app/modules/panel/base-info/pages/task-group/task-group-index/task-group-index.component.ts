...
@Component({
  selector: 'app-taskGroup-index',
  templateUrl: './task-group-index.component.html',
  styleUrls: ['./task-group-index.component.scss']
})
export class TaskGroupIndexComponent extends BaseComponent implements OnInit {
  ...
  constructor(route: ActivatedRoute,
    ...
    private taskGroupService: TaskGroupService,    private dataService: DataService,
