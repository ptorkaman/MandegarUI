...
@Component({
  selector: "app-activity-case-edit",
  templateUrl: "./activity-case-edit.component.html",
  styleUrls: ["./activity-case-edit.component.scss"],
})
export class ActivityCaseEditComponent extends BaseComponent implements OnInit {
  form: FormGroup;
  formModel: ActivityCaseModel;
  roleList = [];
  ...
  private generateForm() {
    this.formModel = new ActivityCaseModel();
