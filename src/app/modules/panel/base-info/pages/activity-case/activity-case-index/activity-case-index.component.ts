...
@Component({
  selector: 'app-activity-case-index',
  templateUrl: './activity-case-index.component.html',
  styleUrls: ['./activity-case-index.component.scss']
})
export class ActivityCaseIndexComponent extends BaseComponent implements OnInit {
  ...
  clearForm() {
    //this.form.reset({ resetCase: ResetFormCase.ControlsOnly });
    this.loadLazy(null);
  }
