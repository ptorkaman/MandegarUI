...
@Component({
  selector: 'app-department-activity-type-index',
  templateUrl: './department-activity-type-index.component.html',
  styleUrls: ['./department-activity-type-index.component.scss']
})
export class DepartmentActivityTypeIndexComponent extends BaseComponent implements OnInit {
