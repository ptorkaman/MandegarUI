...
@Component({
  selector: 'app-department-lesson-add',
  templateUrl: './department-lesson-add.component.html',
  styleUrls: ['./department-lesson-add.component.scss']
})
export class DepartmentLessonAddComponent extends BaseComponent implements OnInit {
  form: FormGroup;
  ...
  constructor(route: ActivatedRoute,
    ...
    private studyDegreeService: DepartmentLessonService
    ) {
    super(route);
  }
