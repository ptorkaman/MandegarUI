...
export class DepartmentIndexComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    ...
    private taskGroupService: DepartmentService,    private dataService: DataService,
  ...
  private generateTable() {
    this.cols = [
      ...
      { field: "parentName", header: "Pages.Departments.Department" },
    ];
  }
  ...
  loadLazy(event: LazyLoadEvent | null) {
    this.loading = true;
    this.taskGroupService.getAll().subscribe((result: any) => {
      if (result.success) {
  ...
  deleteById(id: number) {
    this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        this.taskGroupService.deletebyId(id).subscribe((result) => {
          if (result.success) {
