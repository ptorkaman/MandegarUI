...
@Component({
  selector: 'app-cooperation-type-index',
  templateUrl: './cooperation-type-index.component.html',
  styleUrls: ['./cooperation-type-index.component.scss']
})
export class CooperationTypeIndexComponent extends BaseComponent implements OnInit {
  ...
  constructor(route: ActivatedRoute,
    ...
    private taskGroupService: CooperationTypeService,    private dataService: DataService,
  ...
  deleteById(id: number) {
    this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        this.taskGroupService.deletebyId(id).subscribe(
          result => {
            if (result.success) {
