...
@Component({
  selector: 'app-executive-calendar-index',
  templateUrl: './executive-calendar-index.component.html',
  styleUrls: ['./executive-calendar-index.component.scss']
})
export class ExecutiveCalendarIndexComponent extends BaseComponent implements OnInit {
  ...
  constructor(route: ActivatedRoute,
    private positionService: ExecutiveCalendarService,    private dataService: DataService,
  ...
  private generateTable() {
    this.cols = [
      ...
      { field: 'academicYearName', header: 'Pages.ExecutiveCalendars.AcademicYear' }
