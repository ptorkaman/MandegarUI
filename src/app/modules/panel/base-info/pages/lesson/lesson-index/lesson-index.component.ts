...
export class LessonIndexComponent extends BaseComponent implements OnInit {
  ...
  constructor(route: ActivatedRoute,
    ...
    private studyFieldService: LessonService,    private dataService: DataService,
  ...
  private generateTable() {
    this.cols = [
      ...
      { field: 'lessonTypeName', header: 'Pages.Lessons.LessonTypeId' },
      { field: 'educationCourseCode', header: 'Pages.Lessons.EducationCourseCode' },
      { field: 'courseUnits', header: 'Pages.Lessons.CourseUnits' },
      { field: 'studyGradeName', header: 'Pages.Lessons.StudyGradeId' },
    ];
  }
