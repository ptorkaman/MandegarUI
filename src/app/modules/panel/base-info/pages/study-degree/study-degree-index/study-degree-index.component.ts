...
@Component({
  selector: 'app-study-degree-index',
  templateUrl: './study-degree-index.component.html',
  styleUrls: ['./study-degree-index.component.scss']
})
export class StudyDegreeIndexComponent extends BaseComponent implements OnInit {
