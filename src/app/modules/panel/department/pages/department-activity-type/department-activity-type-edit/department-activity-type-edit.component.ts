...
@Component({
  selector: "app-department-activity-type-edit",
  templateUrl: "./department-activity-type-edit.component.html",
  styleUrls: ["./department-activity-type-edit.component.scss"],
})
export class DepartmentActivityTypeEditComponent extends BaseComponent implements OnInit {
  display: boolean = true;
  form: FormGroup;
  formModel: DepartmentActivityTypeModel;
  roleList = [];
  ...
  private generateForm() {
    this.formModel = new DepartmentActivityTypeModel();
